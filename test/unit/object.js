(function(){
  ...
  var canvas = this.canvas = fabric.isLikelyNode ? createCanvasForNode() : new fabric.StaticCanvas(null, {enableRetinaScaling: false});
  ...
  function createCanvasForNode(width, height, options, nodeCanvasOptions) {
    ...
    var canvasEl = fabric.document.createElement('canvas'),
        nodeCanvas = new fabric.StaticCanvas(null, {renderOnAddRemove: false, enableRetinaScaling: false}),
        nodeCacheCanvas = new fabric.StaticCanvas(null, {renderOnAddRemove: false, enableRetinaScaling: false});
  ...
  QUnit.skip('toJSON', function(assert) {
